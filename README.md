...
```
## Future Work
- Support multiple blocks of if-else in one loop. This may be soon and test on branch [multi_if](https://github.com/jackfsuia/Vecparser/tree/multi_if) has been going on.
